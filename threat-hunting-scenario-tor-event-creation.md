...
6. Create a folder on your desktop called ```tor-shopping-list.txt.txt``` and put a few fake (illicit) items in there
7. Delete the file.
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `April 2, 2026`  | `Oliver Ponder`   
